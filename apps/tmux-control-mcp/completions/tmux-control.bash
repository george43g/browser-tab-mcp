...
_tmux_control() {
    ...
    local spec_file="${TMPDIR:-/tmp}/usage__usage_spec_tmux_control.spec"
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    shopt -u hostcomplete && complete -o nospace -o bashdefault -o nosort -F _tmux_control tmux-control
else
    shopt -u hostcomplete && complete -o nospace -o bashdefault -F _tmux_control tmux-control
fi
