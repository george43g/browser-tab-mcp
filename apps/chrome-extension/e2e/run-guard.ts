 ...
 * green is the exact move this guard exists to catch. Twenty-two is today's suite
 * (load × 1, roundtrip × 2, tabs-lifecycle × 8, tab-action × 7,
 * tab-history × 3, tab-discard × 1); Phase 2 raises it as specs
 * land.
 */
export const EXPECTED_MIN_TESTS = 22;
