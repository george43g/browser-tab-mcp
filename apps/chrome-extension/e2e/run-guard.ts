 ...
 * green is the exact move this guard exists to catch. Eleven is today's suite
 * (load × 1, roundtrip × 2, tabs-lifecycle × 8); Phase 2 raises it as specs
 * land.
 */
export const EXPECTED_MIN_TESTS = 11;
