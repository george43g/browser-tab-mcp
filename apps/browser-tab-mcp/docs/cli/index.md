...
- [`browser-tab logs [--source <src>] [--tail <n>]`](/logs.md)
- [`browser-tab list [FLAGS]`](/list.md)
- [`browser-tab reload-extension [--browser [name]]`](/reload-extension.md)
- [`browser-tab select <--selector <json>> [--projection [p]]`](/select.md)
- [`browser-tab apply <--plan <id>> [--conflict <mode>]`](/apply.md)
- [`browser-tab apply-destructive <--plan <id>> <--confirm-destruction>`](/apply-destructive.md)
- [`browser-tab closed [--browser <name>] [--limit [n]]`](/closed.md)
- [`browser-tab reopen <--id <closedTabId>>`](/reopen.md)
- [`browser-tab operations [--id <operationId>] [--limit <n>]`](/operations.md)
- [`browser-tab copy [FLAGS]`](/copy.md)
- [`browser-tab cut [FLAGS]`](/cut.md)
- [`browser-tab plan [FLAGS]`](/plan.md)
